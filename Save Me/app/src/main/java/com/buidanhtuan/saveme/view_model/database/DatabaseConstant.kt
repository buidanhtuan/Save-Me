...
class DatabaseConstant {
    companion object {
        ...
        const val QUERY_CREATE = "CREATE TABLE IF NOT EXISTS $DATABASE_TABEL ($ROW_ID INTEGER PRIMARY KEY AUTOINCREMENT, $ROW_TYPE TEXT, $ROW_TITLE TEXT, $ROW_CONTENT TEXT, $ROW_IMAGE TEXT)"
